...
class AddAnnotatedClassesToCachePassTest extends TestCase
{
    public function testExpandClasses()
    {
        ...
        $this->assertSame(
            'Acme\\FooBundle\\Controller\\PrepController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\PrepController'))[0]
        );

        $this->assertSame(
            'FooBundle\\Controller\\PrepController',
            $expand(array('**Bundle\\Controller\\'), array('\\FooBundle\\Controller\\PrepController'))[0]
        );

        $this->assertSame(
            'Acme\\FooBundle\\Controller\\Bar\\PrepController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\FooBundle\\Controller\\Bar\\PrepController'))[0]
        );

        $this->assertSame(
            'Bundle\\Controller\\Bar\\PrepController',
            $expand(array('**Bundle\\Controller\\'), array('\\Bundle\\Controller\\Bar\\PrepController'))[0]
        );

        $this->assertSame(
            'Acme\\Bundle\\Controller\\Bar\\PrepController',
            $expand(array('**Bundle\\Controller\\'), array('\\Acme\\Bundle\\Controller\\Bar\\PrepController'))[0]
        );
